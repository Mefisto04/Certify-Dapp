...
import hashlib
from utils.cert_utils import generate_certificate_nta
...
if selected == options[0]:
    ...
    if submit:
        ...
        generate_certificate_nta(pdf_file_path, uid, candidate_name, course_name, org_name, institute_logo_path)
